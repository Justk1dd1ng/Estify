...
from crawlers.utils import get_minfin_currency_rate
...
class Driver:
    ...
    def __init__(self):
        ...
        self.config = Config()
        self.options = self.config.crome_driver_options
...
class FlatImage:
    ...
    def __init__(self, img_binary: bytes, flat_id: str, image_id: int):
